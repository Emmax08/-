...
// *** ADAPTACIÓN PARA MARIA (WONES) ***
// Usamos global.moneda como el código de moneda local (e.g., WON)
const moneda = global.moneda || 'WON'; // Establecemos 'WON' como el valor predeterminado local
const emoji = '✅';
const emoji2 = '❌';
...
    // Asume que el número es todo menos los últimos 7 caracteres (DEN1234, BER1234, WON1234 etc.)
...
                // El re-crédito ocurrió en el backend de CypherTrans, solo notificamos
