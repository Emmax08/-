...
const BOT_API_KEY = 'maria'; // Clave de la API para Maria
const BOT_KEY_PREFIX = 'WON'; // Nuevo prefijo para Wones (Maria)
const ALL_PREFIXES = ['WON', 'BER', 'DEN']; // Wones, Berries, Deniques
const moneda = global.moneda || 'Wones'; // Moneda local
const emoji = '✅';
const emoji2 = '❌';
...
    // 3. ERROR DE FORMATO
    return m.reply(`${emoji2} Formato de destinatario no reconocido. Debe ser @mencion o una cuenta CypherTrans (ej: 01234WON1234).`);
}
